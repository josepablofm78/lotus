...
type SetSealingDelayFunc func(config.Duration) error

// SetSealingDelay returns how long a sector waits for more deals before sealing begins.
type GetSealingDelayFunc func() (config.Duration, error)
