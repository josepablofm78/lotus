...
func (sm *StorageMinerAPI) SectorSetSealDelay(ctx context.Context, delay config.Duration) error {
	return sm.SetSealingDelayFunc(delay)
}

func (sm *StorageMinerAPI) SectorGetSealDelay(ctx context.Context) (config.Duration, error) {
