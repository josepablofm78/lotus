...
type StorageMinerStruct struct {
	...
	Internal struct {
		...
		SectorSetSealDelay   func(context.Context, config.Duration) error                    `perm:"write"`
		SectorGetSealDelay   func(context.Context) (config.Duration, error)                  `perm:"read"`
...
func (c *StorageMinerStruct) SectorSetSealDelay(ctx context.Context, delay config.Duration) error {
	return c.Internal.SectorSetSealDelay(ctx, delay)
}

func (c *StorageMinerStruct) SectorGetSealDelay(ctx context.Context) (config.Duration, error) {
